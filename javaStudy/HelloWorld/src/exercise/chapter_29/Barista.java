...
//2. '바리스타'는 물 500ml와 원두 30g으로 '아메리카노 커피'만든다
...
public class Barista {
    ...
    public void noticeOrder(String coffeeName) {
        System.out.println("바리스타 : 커피주문 확인 했습니다 커피 :" + coffeeName);
    }

    public Coffee makeUpCoffee(String coffeeName, long waterQuantity, long coffeeBeenQuantity) {
        Coffee coffee = new Coffee(coffeeName,waterQuantity,coffeeBeenQuantity);
        return coffee;
    }
